...
`,i+=`- Nome: ${o.name}\n`,i+=`- Telefono: ${o.phone}\n`,o.email&&(i+=`- Email: ${o.email}\n`),o.notes&&(i+=`- Note: ${o.notes}\n`),s({name:``,phone:``,email:``,notes:``});let c=encodeURIComponent(i);e===`whatsapp`?window.open(`https://wa.me/${y.whatsapp}?text=${c}`,`_blank`):e===`email`&&window.open(`mailto:${y.email}?subject=Nuovo Ordine ${t}&body=${c}`,`_blank`)};return(0,x.jsxs)(`div`,{className:`slide-panel-overlay`,onClick:t,children:[(0,x.jsxs)(`div`,{className:`slide-panel cart-panel`,onClick:e=>e.stopPropagation(),children:[(0,x.jsxs)(`div`,{className:`cart-header`,children:[(0,x.jsx)(`h2`,{className:`cart-title`,children:`Il Tuo Carrello`}),(0,x.jsx)(`button`,{className:`cart-close`,onClick:t,"aria-label":`Chiudi carrello`,children:`×`})]}),c?(0,x.jsxs)(`div`,{className:`cart-success-view animate-fade-in`,children:[(0,x.jsx)(`div`,{className:`success-icon-wrapper`,children:(0,x.jsxs)(`svg`,{width:`48`,height:`48`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`,children:[(0,x.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`}),(0,x.jsx)(`polyline`,{points:`12 6 12 12 16 14`})]})}),(0,x.jsx)(`h3`,{children:`Ordine Registrato!`}),(0,x.jsx)(`p`,{className:`success-intro`,children:`Il tuo ordine è stato registrato nel nostro database ed è in elaborazione.`}),(0,x.jsxs)(`div`,{className:`success-order-box`,children:[(0,x.jsx)(`strong`,{children:`Codice Ordine:`}),(0,x.jsx)(`span`,{children:u?.id}),(0,x.jsx)(`br`,{}),(0,x.jsx)(`strong`,{children:`Totale:`}),(0,x.jsxs)(`span`,{children:[`€`,u?.total]})]}),(0,x.jsx)(`p`,{className:`success-outro`,children:`Verrai contattato a breve per finalizzare la consegna.`}),(0,x.jsx)(`button`,{className:`btn btn-primary`,style:{width:`100%`},onClick:()=>{l(!1),d(null),t()},children:`Continua lo Shopping`})]}):(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:`cart-items-container`,children:n.length===0?(0,x.jsxs)(`div`,{className:`cart-empty-message`,children:[(0,x.jsx)(`p`,{children:`Il tuo carrello è vuoto.`}),(0,x.jsx)(`button`,{className:`btn btn-outline`,style:{marginTop:`20px`},onClick:t,children:`Torna allo Shop`})]}):n.map(e=>(0,x.jsxs)(`div`,{className:`cart-item`,children:[(0,x.jsx)(`img`,{src:e.imageUrl,alt:e.name,className:`cart-item-img`}),(0,x.jsxs)(`div`,{className:`cart-item-info`,children:[(0,x.jsx)(`h4`,{className:`cart-item-name`,children:e.name}),(0,x.jsxs)(`span`,{className:`cart-item-details`,children:[`Taglia: `,e.size,` | Colore: `,e.color]}),(0,x.jsxs)(`span`,{className:`cart-item-price`,children:[`€`,e.price]}),(0,x.jsxs)(`div`,{className:`quantity-controls`,children:[(0,x.jsx)(`button`,{className:`qty-btn`,onClick:()=>r(e.id,e.size,e.color,e.quantity-1),children:`-`}),(0,x.jsx)(`span`,{className:`qty-val`,children:e.quantity}),(0,x.jsx)(`button`,{className:`qty-btn`,onClick:()=>r(e.id,e.size,e.color,e.quantity+1),children:`+`})]})]}),(0,x.jsx)(`button`,{className:`cart-item-remove`,onClick:()=>i(e.id,e.size,e.color),title:`Rimuovi`,children:`×`})]},`${e.id}-${e.size}-${e.color}`))}),n.length>0&&(0,x.jsxs)(`div`,{className:`cart-footer`,children:[(0,x.jsxs)(`div`,{className:`cart-total-row`,children:[(0,x.jsx)(`span`,{children:`Totale Stimato`}),(0,x.jsxs)(`span`,{className:`cart-total-price`,children:[`€`,f]})]}),(0,x.jsx)(`div`,{className:`cart-divider`}),(0,x.jsxs)(`form`,{className:`checkout-form`,onSubmit:e=>e.preventDefault(),children:[(0,x.jsx)(`h3`,{className:`checkout-form-title`,children:`Dati per l'Ordine`}),(0,x.jsxs)(`div`,{className:`form-group sm-group`,children:[(0,x.jsx)(`label`,{className:`form-label`,htmlFor:`cart-name`,children:`Nome Completo *`}),(0,x.jsx)(`input`,{type:`text`,id:`cart-name`,name:`name`,className:`form-input`,placeholder:`Alessandro Morreale`,value:o.name,onChange:p,required:!0})]}),(0,x.jsxs)(`div`,{className:`form-group sm-group`,children:[(0,x.jsx)(`label`,{className:`form-label`,htmlFor:`cart-phone`,children:`Telefono *`}),(0,x.jsx)(`input`,{type:`tel`,id:`cart-phone`,name:`phone`,className:`form-input`,placeholder:`+39 347 1234567`,value:o.phone,onChange:p,required:!0})]}),(0,x.jsxs)(`div`,{className:`form-group sm-group`,children:[(0,x.jsx)(`label`,{className:`form-label`,htmlFor:`cart-email`,children:`Email (opzionale)`}),(0,x.jsx)(`input`,{type:`email`,id:`cart-email`,name:`email`,className:`form-input`,placeholder:`alessandro@esempio.it`,value:o.email,onChange:p})]}),(0,x.jsxs)(`div`,{className:`form-group sm-group`,children:[(0,x.jsx)(`label`,{className:`form-label`,htmlFor:`cart-notes`,children:`Note di Spedizione / Dettagli`}),(0,x.jsx)(`textarea`,{id:`cart-notes`,name:`notes`,className:`form-textarea sm-textarea`,placeholder:`Indirizzo per la consegna a Licata o note aggiuntive...`,value:o.notes,onChange:p})]}),(0,x.jsxs)(`div`,{className:`checkout-actions`,children:[(0,x.jsxs)(`button`,{type:`button`,className:`btn btn-primary checkout-btn wa-btn`,onClick:()=>m(`whatsapp`),children:[(0,x.jsx)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 24 24`,fill:`currentColor`,style:{marginRight:`8px`},children:(0,x.jsx)(`path`,{d:`M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.006 5.291 5.4 0 12.007 0c3.2 0 6.208 1.248 8.471 3.515 2.264 2.267 3.509 5.279 3.507 8.487-.006 6.709-5.4 12.001-12.008 12.001-1.996-.001-3.956-.492-5.702-1.43l-6.22 1.63zM6.59 18.06c1.642.975 3.257 1.488 4.954 1.489 5.432 0 9.849-4.298 9.854-9.58A9.378 9.378 0 0 0 18.6 3.42 9.39 9.39 0 0 0 12.006 1.4c-5.43 0-9.845 4.303-9.85 9.585-.002 1.834.498 3.626 1.448 5.236l-1.018 3.714 3.968-1.015L6.59 18.06zm10.252-4.103c-.276-.135-1.63-.787-1.884-.877-.253-.09-.438-.135-.623.135-.184.27-.714.877-.877 1.058-.162.18-.323.2-.6.066-.276-.135-1.162-.417-2.217-1.332-.821-.715-1.376-1.599-1.537-1.87-.162-.272-.017-.418.12-.553.123-.122.276-.315.415-.473.139-.158.185-.27.277-.45.093-.18.046-.338-.023-.473-.069-.135-.623-1.463-.854-2.002-.224-.526-.452-.455-.623-.464-.162-.008-.346-.01-.53-.01-.184 0-.485.068-.739.338-.253.27-.969.923-.969 2.25s.992 2.61 1.131 2.79c.139.18 1.954 2.912 4.733 4.083.661.278 1.177.444 1.579.57.665.207 1.27.177 1.748.107.534-.078 1.63-.65 1.859-1.278.228-.627.228-1.166.16-1.278-.07-.112-.254-.202-.53-.338z`})}),`Invia tramite WhatsApp`]}),(0,x.jsx)(`button`,{type:`button`,className:`btn btn-outline checkout-btn email-btn`,onClick:()=>m(`email`),children:`Ordina via Email`})]})]})]})]})]}),(0,x.jsx)(`style`,{children:`
      ...
      3. Sii coerente con la tua personalità: sei ${d}, assistente virtuale ${u?`femminile fatta di lana calda e accogliente`:`maschile fatto di una fresca fibra di lino siciliana`}.
    `,i=n.map(e=>({role:e.role===`user`?`user`:`model`,parts:[{text:e.text}]}));i.push({role:`user`,parts:[{text:t}]});let a=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${e}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({systemInstruction:{parts:[{text:r}]},contents:i})});if(!a.ok){let e=await a.json();throw Error(e.error?.message||`Errore sconosciuto API Gemini`)}return(await a.json()).candidates[0].content.parts[0].text},h=e=>{let t=e.toLowerCase();return t.includes(`orari`)||t.includes(`apertura`)||t.includes(`chiuso`)||t.includes(`sabato`)||t.includes(`domenica`)?`Siamo aperti dal Lunedì al Sabato dalle 09:00 alle 13:00 e il pomeriggio dalle 16:30 alle 20:30. La Domenica la boutique è chiusa. Ti consigliamo di prenotare una visita in Atelier se desideri una prova personalizzata!`:t.includes(`dove`)||t.includes(`indirizzo`)||t.includes(`licata`)||t.includes(`mappa`)||t.includes(`trova`)?`La boutique Morreale Abbigliamento si trova nel centro storico di Licata (Agrigento), in Via Corso Umberto I. Vieni a trovarci per toccare con mano le nostre collezioni!`:t.includes(`contatt`)||t.includes(`telefono`)||t.includes(`mail`)||t.includes(`chiamare`)||t.includes(`whatsapp`)?`Puoi chiamarci al numero +39 0922 851000, scriverci via email a alessiocostanza3@gmail.com o avviare un ordine via WhatsApp direttamente dal carrello. Siamo a tua completa disposizione!`:t.includes(`appuntament`)||t.includes(`prenot`)||t.includes(`visita`)||t.includes(`prova`)?`Prenotare un appuntamento è semplicissimo! Puoi scorrere in fondo alla Home Page e compilare il nostro modulo di prenotazione scegliendo data, ora e il servizio desiderato (es. Prova abito o Sartoria su misura). Ti invieremo una conferma immediata.`:t.includes(`tessut`)||t.includes(`lana`)||t.includes(`lino`)||t.includes(`seta`)||t.includes(`cashmere`)||t.includes(`loro piana`)?`Selezioniamo solo filati nobili. Utilizziamo Lana Super 130s e Cashmere di Loro Piana, Lino Fiammato di Solbiati e Pura Seta delle storiche tessiture di Como. Puoi esplorare la nostra 'Tessutoteca' nella sezione Filosofia della Home Page!`:t.includes(`spedizion`)||t.includes(`consegna`)||t.includes(`costo`)||t.includes(`tempi`)||t.includes(`spedire`)?`Le spedizioni sono gratuite in tutta Italia per ordini superiori a 150€. Per cifre inferiori, la tariffa standard è di 8€. La consegna avviene tramite corriere espresso in 2-3 giorni lavorativi.`:t.includes(`pagamento`)||t.includes(`paypal`)||t.includes(`carta`)||t.includes(`contrassegno`)||t.includes(`pagare`)?`Accettiamo pagamenti sicuri con Carta di Credito, PayPal e contrassegno (pagamento in contanti direttamente al corriere alla consegna del pacco senza costi aggiuntivi).`:t.includes(`fabrizio`)||t.includes(`proprietario`)||t.includes(`fondatore`)?`Il titolare della boutique è Fabrizio Morreale. Da anni seleziona personalmente i migliori capi sartoriali e tessuti per offrire ai clienti di Licata e di tutta Italia un'eleganza classica senza tempo.`:`Sono ${d}, il tuo assistente virtuale di Morreale Abbigliamento. 
